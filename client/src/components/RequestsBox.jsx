...
<article className="friend-box bg-white p-4 rounded-lg shadow-md border border-gray-300 flex items-center space-x-4">
  <IoPersonOutline className="user-icon w-12 h-12 text-gray-500" aria-hidden="true" />
  
  <div className="flex flex-col flex-grow">
    <h4 id={`request-${_id}`} className="name text-lg font-semibold text-gray-800 mb-2">
      {name}
    </h4>
    <div className="flex space-x-2">
      ...
      >
        <IoCheckmarkSharp className="accept-icon w-5 h-5" aria-hidden="true" />
        <span>Accept</span>
      </button>
      <button
